...
"%":"AudioParam|DOMError|FileError|MediaError|MediaKeyError|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedNumberList"},
kn:{
"^":"bool/Gv;",
...
H.qG(a,b+z,y,a,b)
for(y=new H.a7(c,c.length,0,null);y.G();b=x){x=b+1
C.Nm.u(a,b,y.lo)}},
...
"%":"AnalyserNode|AudioDestinationNode|AudioGainNode|AudioNode|AudioSourceNode|GainNode|JavaScriptAudioNode|MediaStreamAudioDestinationNode|MediaStreamAudioSourceNode|Oscillator|OscillatorNode|RealtimeAnalyserNode|ScriptProcessorNode;EventTarget"},
as:{
"^":"qE;oc:name=",
"%":"HTMLFieldSetElement"},
Yu:{
...
return y.MM},
e7:function(a,b){return this.Ux(a,b,!1)},
...
p5:function(a){this.CE.setAttribute("class",a.zV(0," "))}}}],["dart.dom.web_audio","dart:web_audio",,P,{
"^":"",
r2:{
"^":"Gv;B:length=",
"%":"AudioBuffer"},
...
xl:{
"^":"ea;Aa:inputBuffer=",
"%":"AudioProcessingEvent"}}],["dart.isolate","dart:isolate",,P,{
"^":"",
IU:{
"^":"a;",
$isIU:true,
...
"^":"Tp:7;",
call$1:function(a){var z=J.x(a)
return typeof a==="object"&&a!==null&&!!z.$iscv}}}],["","file:///C:/Users/Peter/Documents/Google%20Drive/clients/vectorshapes.com/web/sasa_buki_p6/web/sasa_buki_p6.dart",,V,{
"^":"",
Iq:[function(){var z,y,x,w,v,u
z=$.cM().createOscillator()
z.type="triangle"
y=$.cM().createGainNode()
z.frequency.value=400
z.connect(y,0,0)
y.connect($.cM().destination,0,0)
y.gain.value=0
z.start(0)
x=J.no($.cM(),2048,1,1)
w=$.cM().createAnalyser()
w.smoothingTimeConstant=0.3
w.fftSize=1024
v=$.cM().createMediaStreamDestination()
J.Uv(window.navigator,!0).ml(new V.em(x,w,v))
u=H.VM(new W.RO(x,C.d3.Ph,!1),[null])
H.VM(new W.xC(0,u.uv,u.Ph,W.VF(new V.Lb(w)),u.Sg),[H.Kp(u,0)]).Zz()
u=J.Vg(document.querySelector("#btnPlaySample"))
H.VM(new W.xC(0,u.uv,u.Ph,W.VF(new V.QA(z,y)),u.Sg),[H.Kp(u,0)]).Zz()
u=J.Vg(document.querySelector("#btnStartSample"))
H.VM(new W.xC(0,u.uv,u.Ph,W.VF(new V.Cv()),u.Sg),[H.Kp(u,0)]).Zz()
u=J.Vg(document.querySelector("#btnStopSample"))
H.VM(new W.xC(0,u.uv,u.Ph,W.VF(new V.ed()),u.Sg),[H.Kp(u,0)]).Zz()},"call$0","eE",0,0,0],
...
z.a=0
$.op=1
H.Go(document.querySelector("#btnPlaySample"),"$isIF").disabled=!0
$.Ar=P.SZ(P.k5(0,0,0,50,0,0),new V.UX(z,a,b,c))},
V4:function(a,b){var z,y,x,w,v,u,t,s,r,q,p,o
for(z=J.U6(a),y=0,x=0;x<1000;++x){w=(z.t(a,x)-128)/128
y+=w*w}y=Math.sqrt(y/1000)
for(v=a.length,u=-1,t=0,s=4;s<=1000;++s){for(r=0,x=0;x<1000;++x){q=x+s
if(q<z.gB(a)){if(x>=v)return H.e(a,x)
p=a[x]
if(q>=v)return H.e(a,q)
r+=Math.abs((p-128)/128-(a[q]-128)/128)}}r=1-r/1000
if(r>t){t=r
u=s}}if(y>0.01&&t>0.01){if(typeof b!=="number")return b.V()
o=b/u}else o=0
return o},
wd:function(a){var z,y,x,w,v
z=document.querySelector("#gSamples")
y=document.createElementNS("http://www.w3.org/2000/svg","path")
y.setAttribute("d",a.IU)
x=a.bM
w=$.zi
if(typeof x!=="number")return x.Y()
w="translate("+C.jn.Y(x,w)*40+","
x=a.bM
v=$.zi
if(typeof x!=="number")return x.Z()
y.setAttribute("transform",w+C.jn.Z(x,v)*70+") scale(0.2) ")
y.setAttribute("stroke","white")
y.setAttribute("fill","white")
v=""+H.eQ(a)
y.setAttribute("data-"+new W.Sy(new W.i7(y)).kZ("hash"),v)
v=J.RE(y)
v.gDD(y).h(0,"sample")
J.Vl(y.style,"pointer")
J.OG(z).h(0,y)
v=v.gVl(y)
H.VM(new W.xC(0,v.uv,v.Ph,W.VF(new V.Zl(a)),v.Sg),[H.Kp(v,0)]).Zz()},
Jn:function(a){var z,y,x
z={}
if(a.nZ.length===0)return
y=$.cM().createOscillator()
y.type="triangle"
x=$.cM().createGainNode()
y.frequency.value=400
y.connect(x,0,0)
x.connect($.cM().destination,0,0)
x.gain.value=0
y.start(0)
z.a=0
P.SZ(P.k5(0,0,0,50,0,0),new V.Dg(z,a,y,x))},
Me:{
"^":"a;OK>,ag<"},
Fd:{
"^":"a;nZ,IU,bM"},
...
z=this.b
$.cM().createMediaStreamSource(a).connect(z,0,0)
y=this.a
z.connect(y,0,0)
y.connect(this.c,0,0)}},
Lb:{
"^":"Tp:21;d",
call$1:function(a){var z,y,x,w,v,u,t,s,r,q,p
if($.op===0){z=J.CP(a).getChannelData(0)
y=this.d
x=y.frequencyBinCount
if(typeof x!=="number"||Math.floor(x)!==x)H.vh(new P.AT("Invalid length "+H.d(x)))
w=new Uint8Array(x)
y.getByteFrequencyData(w)
y=C.NA.es(w,0,new V.VW())
if(typeof y!=="number")return y.V()
v=y/w.length
if(v>20){if($.Sm){C.Nm.sB($.My(),0)
$.Sm=!1}u=document.querySelector("#svgPath").getAttribute("d")
y=$.B9
x=v*2
t=C.CD.yu(x)
s=$.B9
x=C.CD.yu(x)
r=document.querySelector("#svgPath")
r.toString
t=u+" L"+(y-t)+","
y=$.Bp
$.Bp=y+1
...
s=$.Bp
$.Bp=s+1
r.setAttribute("d",x+s+" ")
q=V.V4(z,$.cM().sampleRate)
$.My().push(new V.Me(v,q))
$.bM=!0}else{if($.XS&&$.bM){y=$.My()
x=[]
p=new V.Fd(x,document.querySelector("#svgPath").getAttribute("d"),null)
H.IC(x,0,y)
y=$.bm()
p.bM=y.gB(y)
y.u(0,H.eQ(p),p)
V.wd(p)
$.bM=!1}y=document.querySelector("#svgPath")
y.toString
y.setAttribute("d","M"+$.B9+",0")
$.Bp=0
$.Sm=!0}}}},
VW:{
"^":"Tp:6;",
...
QA:{
"^":"Tp:7;e,f",
call$1:function(a){return V.oP(this.f,this.e,$.cM())}},
Cv:{
"^":"Tp:7;",
call$1:function(a){H.Go(document.querySelector("#btnStartSample"),"$isIF").disabled=!0
J.Ed(document.querySelector("#circleRecord").style,"1.0")
$.XS=!0}},
ed:{
"^":"Tp:7;",
call$1:function(a){H.Go(document.querySelector("#btnStartSample"),"$isIF").disabled=!1
J.Ed(document.querySelector("#circleRecord").style,"0")
$.XS=!1}},
UX:{
"^":"Tp:7;a,b,c,d",
call$1:function(a){var z,y,x,w,v,u,t,s,r,q
z=document.querySelector("#svgPath").getAttribute("d")
y=$.B9
x=$.My()
w=this.a
v=w.a
...
t=C.CD.yu(u[t].OK*2)
u=document.querySelector("#svgPath")
u.toString
u.setAttribute("d",z+" L"+(y-v)+","+w.a*2+" L"+(x+t)+","+w.a*2)
t=this.d.sampleRate
...
if(y[x].ag>=s){if(x>=v)return H.e(y,x)
u=y[x].ag<=r}else u=!1
if(u){u=this.c.frequency
if(x>=v)return H.e(y,x)
u.value=y[x].ag}y=this.b
this.c.connect(y,0,0)
x=y.gain
v=$.My()
u=w.a
q=u+1
...
y.gain.value=0
$.op=0
H.Go(document.querySelector("#btnPlaySample"),"$isIF").disabled=!1}}},
Zl:{
"^":"Tp:7;a",
call$1:function(a){return V.Jn(this.a)}},
Dg:{
"^":"Tp:7;a,b,c,d",
...
t=C.CD.yu(t*2)
s=document.querySelector("#svgPath")
s.toString
s.setAttribute("d",z+" L"+(y-v)+","+w.a*2+" L"+(u+t)+","+w.a*2)
t=$.cM()
u=t.sampleRate
...
if(y>=x.length)return H.e(x,y)
y=x[y].gag()
if(y>=u&&y<=t)this.c.frequency.value=y
y=this.c
v=this.d
y.connect(v,0,0)
v=v.gain
...
I.$lazy($,"_sample","UW","My",function(){return[]})
I.$lazy($,"_samples","f6","bm",function(){return H.B7([],P.L5(null,null,null,null,null))})
I.$lazy($,"context","eo","cM",function(){return new (window.AudioContext||window.webkitAudioContext)()})

init.functionAliases={}
init.metadata=[{func:"X0",void:true},{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"uO",args:[J.O]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:J.kn},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Cu",ret:J.O,args:[J.im]},{func:"B2",args:[J.O,J.O]},{func:"ZH",args:[J.im]},{func:"iR",args:[J.im,null]},{func:"Uw",args:[W.D8]},{func:"AV",args:[P.xl]},];$=null
...
El.prototype.gOK=function(receiver){return receiver.volume}
...
if($desc instanceof Array)$desc=$desc[1]
Zf.prototype=$desc
function Me(OK,ag){this.OK=OK
this.ag=ag}Me.builtin$cls="Me"
if(!"name" in Me)Me.name="Me"
$desc=$collectedClasses.Me
if($desc instanceof Array)$desc=$desc[1]
Me.prototype=$desc
Me.prototype.gOK=function(receiver){return this.OK}
Me.prototype.gag=function(){return this.ag}
function Fd(nZ,IU,bM){this.nZ=nZ
this.IU=IU
this.bM=bM}Fd.builtin$cls="Fd"
if(!"name" in Fd)Fd.name="Fd"
$desc=$collectedClasses.Fd
if($desc instanceof Array)$desc=$desc[1]
Fd.prototype=$desc
...
if($desc instanceof Array)$desc=$desc[1]
em.prototype=$desc
function Lb(d){this.d=d}Lb.builtin$cls="Lb"
if(!"name" in Lb)Lb.name="Lb"
$desc=$collectedClasses.Lb
if($desc instanceof Array)$desc=$desc[1]
Lb.prototype=$desc
...
this.b=b
this.c=c
this.d=d}Dg.builtin$cls="Dg"
if(!"name" in Dg)Dg.name="Dg"
$desc=$collectedClasses.Dg
if($desc instanceof Array)$desc=$desc[1]
Dg.prototype=$desc
return[qE,Gh,rK,fY,Mr,lJ,ct,nB,i3,it,QP,IF,n6,Ny,nx,QQ,fW,y4,d7,Um,oJ,He,HA,vH,xO,Em,NW,rV,Wy,QF,hs,cm,Nh,cv,Fs,hY,ea,D0,as,Aa,u5,Yu,iG,jP,Ax,xf,xn,Vb,QH,ST,X2,tb,pA,Mi,HL,In,wP,eP,A6,Og,M6,El,mC,SV,aB,fJ,Ih,D8,Vh,rC,ZY,cx,Ee,Qb,PG,F3,xI,Aj,oU,eY,KV,BH,KY,G7,l9,Ql,wL,bP,FH,SN,HD,ni,rR,qj,nC,KR,ew,fs,bX,lr,MC,iQ,j2,Ea,lp,kd,I0,yN,Cp,ua,HN,Ul,KK,ii,fq,h4,qk,GI,Tb,Iv,BT,yY,kJ,FB,xV,YS,y6,RH,Kn,Z2,w6,BR,vw,aG,J6,Oi,UM,hq,WS,r0,yp,c1,Mq,Nf,Nc,Mx,rh,Zv,Q7,yK,Dh,ZJ,mU,eZ,IT,nV,ui,D6,DQ,nL,xL,es,jw,lv,pf,NV,W1,zo,wf,TU,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,d4,MI,Ub,kK,eW,Qy,ju,OE,N9,BA,d0,tp,rE,CC,PQ,uz,Yd,p8,AD,Gr,Gq,GH,To,NJ,qI,jf,rQ,fv,LR,d5,hy,r8,aS,CG,UN,MT,Rk,Eo,ZG,ox,ZD,vt,cu,BD,vR,j8,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,qO,xt,tG,P0,VN,r2,WK,p2,vN,rO,xl,XN,Jm,Id,cX,Dc,Gn,YR,i6,Sl,Qm,ET,zU,V6,FK,Gv,kn,YE,Ue,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,cC,RA,IY,JH,bL,Iy,JM,Ua,ns,yo,Bj,NO,II,fP,X1,HU,oo,OW,Tf,iY,yH,FA,Av,DH,ku,FD,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,lc,v,Pe,Eq,lb,tD,hJ,dC,wN,VX,a7,i1,xy,MH,U5,SO,SU,Ca,Pf,Lj,vs,da,xw,dm,rH,ZL,rq,RW,YP,jZ,FZ,OM,qh,lz,Rl,Jb,M4,B5,PI,MO,nP,v1,uR,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,N6,jg,YO,oz,b6,tj,zQ,u3,mW,ar,lD,ZQ,Sw,o0,CL,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,kM,An,c8,a,mE,Rn,wv,BV,id,VG,zL,ec,Lx,QM,e7,hm,kE,nj,x5,tJ,i7,Sy,KS,A3,aY,I4,Fk,RO,eu,xC,Pb,W9,O7,IU,b0,XU,Ob,GV,Pg,fj,Ip,aI,rG,yh,wO,Tm,ib,As,GE,D7,Zf,Me,Fd,em,Lb,VW,QA,Cv,ed,UX,Zl,Dg]}
I'm going to gloss over the server app component of the project. It will basically be a REST web service url that will receive/retrieve user's sample data to/from a NoSql datastore (Google Datastore). 
